...
class VisionTransformer(nn.Module):
    ...
    """
    def __init__(self, input_dim=2048, embed_dim=256, depth=4, num_patches=48, nclass=17,
                 decoder_feat_HxW=48, num_heads=8, mlp_ratio=3., qkv_bias=False, qk_scale=None,
